...
The whole project we are going to build is available [here](https://github.com/another-ai/embedbase-nextra-docs-template). You can also try an interactive version at https://docs.embedbase.xyz.
