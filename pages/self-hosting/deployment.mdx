...
settings = Settings(vector_database="postgres", openai_api_key="<your key>")
...
settings = Settings(vector_database="supabase", openai_api_key="<your key>")
app = get_app(settings).use(Supabase("<your url>", "<your key>")).run()
```
