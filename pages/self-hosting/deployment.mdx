...
3. Enable pgvector extension by running the following query
...
4. Run the following query to create the table
...
5. Enable row-level security (prevent client from read & write access to the db)
...
6. Create the search database function
...
8. Add the following to your config.yaml file
