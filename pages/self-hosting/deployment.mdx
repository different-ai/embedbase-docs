...
<Image src="/supabase-click-on-database.png" width={800} height={500} />

3. Click on Extensions

<Image src="/supabase-click-on-extensions.png" width={800} height={500} />

4. Enable Vector extension

<Image src="/supabase-enable-vector.png" width={800} height={500} />

5. Go to SQL Editor and run the following query to create the table

<Image src="/supabase-click-on-sqleditor.png" width={800} height={500} />
